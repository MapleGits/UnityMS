    ...
    public MapleMap getMap(int mapid, boolean respawns, boolean npcs, boolean reactors) {
        ...
        if (map == null) {
            synchronized (this) {
                ...
                if (mapData.getChildByPath("everlast") != null) {
                    map.setEverlast(true);
                }
                if (mapData.getChildByPath("forcedReturn") != null) {
                    map.setForcedReturnMap(MapleDataTool.getInt(mapData.getChildByPath("forcedReturn"), 0));
                }
                maps.put(omapid, map);
