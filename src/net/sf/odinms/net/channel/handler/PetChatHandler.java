...
public class PetChatHandler extends AbstractMaplePacketHandler {
	...
	private static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(PetChatHandler.class);
	...
	public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
		...
		//log.info("To be sent: {}", MaplePacketCreator.petChat(player.getId(), unknownShort, text));
